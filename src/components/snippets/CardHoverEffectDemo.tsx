...
import { PiAppStoreLogoBold, PiHeadsetFill, PiLock, PiMegaphone, PiMonitor, PiStorefrontBold } from "react-icons/pi";
...
export const projects = [
    {
      ...
      {
        icon : <div className="bg-blue-100 p-4 rounded-full"><PiStorefrontBold className="w-8 h-8 text-blue-600" /></div>,
      ...
      {
        icon : <div className="bg-blue-100 p-4 rounded-full"><PiAppStoreLogoBold className="w-8 h-8 text-blue-600" /></div>,
